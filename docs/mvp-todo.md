...
1. **구매자 추천 품질** — #100(I-1 계약 정합) → #101(pgvector 2차 압축 복구). 데모 핵심.
2. **구매자 버그** — #119(취향 과반영) · #115(카테고리 추측 정확도) · #120(재추천 차단)
3. **판매자 확장** — #91(분석 기준서 RAG) · #122(시맨틱 캐시)
4. **Spring 협의 잔여** — 아래 표. 대부분 해소, 남은 것은 운영 정책 성격.
