...
| [SPEC-PROFILE-GRAPH-149](SPEC-PROFILE-GRAPH-149.md) | v0.3.0 | 개인화 관계 그래프 — node·edge 투영, 결정론적 식별·병합, 사용자 수정·삭제(즉시 물리 삭제 + 영구 tombstone)·초기화·개인화 중지, 민감정보 경계 (⚠️ **본 저장소 최초 작성 — 정본 승격 필요**, 계약 확정·Post-MVP / 구현은 #150) | `app/agents/profile/`(#150 예정) |
...
| [BE-NEGOTIATION-GRAPH-357](BE-NEGOTIATION-GRAPH-357.md) | v2.3.0 | 개인화 그래프 Spring 협의 4건 — **C-20·C-21·C-27 은 `jarvis-backend#132`(2026-08-08)로 회신 완료, api-spec 반영은 #499**. ⚠️ 본문의 "C-27 캐시 무효화 2곳 축소" 제안은 **실제 구현 4곳과 다르다**(api-spec §5 C-27 이 정본) | 코드 없음(문서 전용, #150 착수 전) |
