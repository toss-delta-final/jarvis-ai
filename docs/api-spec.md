...
> 동기화: **v0.15.17 기준 2026-07-22**.

| 항목 | 값 |
|---|---|
| 문서 버전 | v0.15.17 |
| 작성일 | 2026-07-14 (v0.15.17 개정 2026-07-22) |
| 상태 | draft |
...
| C-8 | **[해소 v0.15.17] 세션 종료 통지 = I-20** | `POST /events/session-end` `{sessionId,userId(number BIGINT),reason?}` + `X-Internal-Token`. UUID 포함 불투명 sessionId, 파생 멱등키, 202 `accepted`/`duplicate`(§3.5) | 이슈 #62 / Spring PR #24 | 🟢 계약 확정 — 알려진 reason 4종, enum 미강제 |
