...
> 동기화: **v0.15.14 기준 2026-07-20**. ⚠️ **v0.15.15는 AI 사본 선반영(I-21 reasons 확정)** — 정본(기획 repo) 백포트 필요.

| 항목 | 값 |
|---|---|
| 문서 버전 | v0.15.15 (사본 선반영; 정본 백포트 대기) |
| 작성일 | 2026-07-14 (v0.15.15 개정 2026-07-22) |
| 상태 | draft |
