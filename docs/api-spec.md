...
| 버전 | 날짜 | 변경 |
|---|---|---|
| v0.29.0 | 2026-08-09 | **[#472] Notion 정본 전수 대조 사본 동기화.** I-21의 `VALIDATION_ERROR` 필수 필드에 `recommendationRequestId`·`listType`를 보완하고, I-24 성공 삭제의 Spring server-side `remove_from_cart` 적재를 명시했으며, I-26~I-28 internal 레인의 403 행을 제거했다. I-29~I-31은 정본 확정·구현 완료 상태로 갱신했다. I-32~I-34/I-36의 suppressed/undo 계열 필드와 I-35 restore를 제거해 즉시 물리 삭제 계약으로 맞췄다. 코드 변경 또는 정본의 미해결 사항은 `docs/api-spec-canonical-audit.md`에 분리했다. |
