...
- 관련: #196, jarvis-backend#62, `app/agents/seller/tools.py`(`_BEHAVIOR_AUTHORITY_NOTE`·`_summarize_behavior`), `app/core/config.py`(`seller_summary_max_products`), api-spec §4.4 I-13 v0.16.3
