...
prompt=f99a98867e4a (repo:_SYSTEM) · tier=fast · model=gpt-5-nano · fixture=underspec-anchors-v1 · N=8 · underspecifiedReaskEnabled=True
...
| constraint_price | 7/40 (17.5%) | [8.7%, 31.9%] |
...
`falseAlarmRate`(multiturn_gate 제외): 5/104 (4.8%)
CI95 [2.1%, 10.8%]
...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 59/100 (59.0%) | CI95 [49.2%, 68.1%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
| `falseAlarmRate` 오탐율 | 5/104 (4.8%) | CI95 [2.1%, 10.8%] | confirmatory-secondary | 판정 True | expectedReask=false 앵커의 recommend 표본(multiturn_gate 슬라이스 제외)(F-1) |
| `falseAlarmRateWithGateSlice` 오탐율 | 5/128 (3.9%) | CI95 [1.7%, 8.8%] | exploratory | 판정 True | expectedReask=false 앵커의 recommend 표본(게이트 포함)(F-1) |
| `falseAlarmRateWithNonRecommendIntent` 오탐율(비-recommend 포함, 참고용) | 5/104 (4.8%) | CI95 [2.1%, 10.8%] | exploratory | 판정 True | expectedReask=false 표본(intent 무관, multiturn_gate 제외, 포함판) |
...
| `judgmentAccuracy` 판정 정확도 | 194/216 (89.8%) | CI95 [85.1%, 93.2%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 제외)(F-1) |
| `judgmentAccuracyWithGateSlice` 판정 정확도 | 218/240 (90.8%) | CI95 [86.5%, 93.9%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 포함)(F-1) |
| `missRate` 미탐율 | 17/112 (15.2%) | CI95 [9.7%, 23.0%] | confirmatory-primary | 판정 False | expectedReask=true 앵커의 recommend 표본 — 프로덕션은 intent==recommend 인 턴에서만 is_underspecified_turn 을 호출한다(F-1) |
| `missRateUnderExpansionAssumption` 미탐율(전개 가정 상한) | 72/112 (64.3%) | CI95 [55.1%, 72.6%] | exploratory | (판정 False) 또는 (판정 True ∧ detect_expansion_need 가 사유를 돌려줌) | expectedReask=true 앵커의 recommend 표본(F-1) |
| `missRateWithNonRecommendIntent` 미탐율(비-recommend 포함, 참고용) | 17/112 (15.2%) | CI95 [9.7%, 23.0%] | exploratory | 판정 False | expectedReask=true 앵커의 표본 전부(intent 무관, 포함판) |
...
| constraint_price | 33/40 (82.5%) | [68.1%, 91.3%] |
| constraint_budget_set | 28/32 (87.5%) (exploratory: N<40) | [71.9%, 95.0%] |
| what_axis | 59/64 (92.2%) | [83.0%, 96.6%] |
...
| constraint_price | 7/40 (17.5%) | [8.7%, 31.9%] |
| constraint_budget_set | 26/32 (81.2%) (exploratory: N<40) | [64.7%, 91.1%] |
| what_axis | 0/0 (해당 없음) | N/A |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 33/34 (97.1%) (exploratory: N<40) | [85.1%, 99.5%] |
| constraint_price | 0/33 (0.0%) (exploratory: N<40) | [0.0%, 10.4%] |
| constraint_budget_set | 22/28 (78.6%) (exploratory: N<40) | [60.5%, 89.8%] |
| what_axis | 4/5 (80.0%) (exploratory: N<40) | [37.6%, 96.4%] |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
outcome 분포: {'correctReject': 123, 'falseAlarm': 5, 'hit': 95, 'miss': 17}
...
- `expansionGateWouldFireRate`: 59/100 (59.0%)
- `missRateUnderExpansionAssumption`: 72/112 (64.3%)
