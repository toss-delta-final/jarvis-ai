...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 64/109 (58.7%) | CI95 [49.3%, 67.5%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| `judgmentAccuracy` 판정 정확도 | 205/216 (94.9%) | CI95 [91.1%, 97.1%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 제외)(F-1) |
| `judgmentAccuracyWithGateSlice` 판정 정확도 | 229/240 (95.4%) | CI95 [92.0%, 97.4%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 포함)(F-1) |
...
| `missRateUnderExpansionAssumption` 미탐율(전개 가정 상한) | 68/112 (60.7%) | CI95 [51.5%, 69.3%] | exploratory | (판정 False) 또는 (판정 True ∧ detect_expansion_need 가 사유를 돌려줌) | expectedReask=true 앵커의 recommend 표본(F-1) |
...
| no_condition | 39/40 (97.5%) | [87.1%, 99.6%] |
| constraint_price | 5/40 (12.5%) | [5.5%, 26.1%] |
| constraint_budget_set | 24/32 (75.0%) (exploratory: N<40) | [57.9%, 86.7%] |
| what_axis | 0/0 (해당 없음) | N/A |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 38/39 (97.4%) (exploratory: N<40) | [86.8%, 99.5%] |
| constraint_price | 0/35 (0.0%) (exploratory: N<40) | [0.0%, 9.9%] |
| constraint_budget_set | 23/31 (74.2%) (exploratory: N<40) | [56.8%, 86.3%] |
| what_axis | 3/4 (75.0%) (exploratory: N<40) | [30.1%, 95.4%] |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
outcome 분포: {'correctReject': 124, 'falseAlarm': 4, 'hit': 105, 'miss': 7}
...
- `expansionGateWouldFireRate`: 64/109 (58.7%)
- `missRateUnderExpansionAssumption`: 68/112 (60.7%)
