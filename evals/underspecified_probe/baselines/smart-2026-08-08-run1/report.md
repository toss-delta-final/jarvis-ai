...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 1/48 (2.1%) | CI95 [0.4%, 10.9%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| `missRateUnderExpansionAssumption` 미탐율(전개 가정 상한) | 57/104 (54.8%) | CI95 [45.2%, 64.0%] | exploratory | (판정 False) 또는 (판정 True ∧ detect_expansion_need 가 사유를 돌려줌) | expectedReask=true 앵커의 recommend 표본(F-1) |
| `missRateWithNonRecommendIntent` 미탐율(비-recommend 포함, 참고용) | 56/112 (50.0%) | CI95 [40.9%, 59.1%] | exploratory | 판정 False | expectedReask=true 앵커의 표본 전부(intent 무관, 포함판) |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 1/1 (100.0%) (exploratory: N<40) | [20.7%, 100.0%] |
| constraint_price | 0/39 (0.0%) (exploratory: N<40) | [0.0%, 9.0%] |
...
|---|---|---|
| **전체(게이트 제외)** | 73.1% | 50.0% |
| no_condition | 2.5% | 0.0% |
| constraint_price | 97.5% | 0.0% |
...
outcome 분포: {'correctReject': 128, 'hit': 56, 'miss': 56}
...
- `expansionGateWouldFireRate`: 1/48 (2.1%)
- `missRateUnderExpansionAssumption`: 57/104 (54.8%)
