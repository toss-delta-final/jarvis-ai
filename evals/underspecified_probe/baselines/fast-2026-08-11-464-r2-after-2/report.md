...
| constraint_budget_set | 6/32 (18.8%) (exploratory: N<40) | [8.9%, 35.3%] |
...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 52/100 (52.0%) | CI95 [42.3%, 61.5%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| `judgmentAccuracy` 판정 정확도 | 202/216 (93.5%) | CI95 [89.4%, 96.1%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 제외)(F-1) |
| `judgmentAccuracyWithGateSlice` 판정 정확도 | 226/240 (94.2%) | CI95 [90.4%, 96.5%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 포함)(F-1) |
...
| constraint_budget_set | 17/26 (65.4%) (exploratory: N<40) | [46.2%, 80.6%] |
| what_axis | 0/0 (해당 없음) | N/A |
...
| constraint_budget_set | 81.2% (exploratory: N<40) | 0.0% |
...
outcome 분포: {'correctReject': 127, 'falseAlarm': 1, 'hit': 99, 'miss': 13}
...
|---|---|
| `categoryQueries` | 1 |
| `categoryQueries;semanticQueryIsFallback` | 10 |
| `semanticQueryIsFallback` | 2 |
...
- `expansionGateWouldFireRate`: 52/100 (52.0%)
...
| `buy-under-0005` | what_axis | 8 | 9 |
| `buy-under-0006` | multiturn_gate | 8 | 9 |
| `buy-under-0007` | blocking_rating | 8 | 9 |
| `under-br-0001` | blocking_rating | 8 | 9 |
...
| `under-nc-0002` | no_condition | 8 | 9 |
