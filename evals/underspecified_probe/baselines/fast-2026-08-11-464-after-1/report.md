...
| `missRateUnderExpansionAssumption` 미탐율(전개 가정 상한) | 56/112 (50.0%) | CI95 [40.9%, 59.1%] | exploratory | (판정 False) 또는 (판정 True ∧ detect_expansion_need 가 사유를 돌려줌) | expectedReask=true 앵커의 recommend 표본(F-1) |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 31/34 (91.2%) (exploratory: N<40) | [77.0%, 97.0%] |
...
outcome 분포: {'correctReject': 128, 'hit': 101, 'miss': 11}
...
- `missRateUnderExpansionAssumption`: 56/112 (50.0%)
...
| `under-cp-0004` | constraint_price | 8 | 9 |
| `under-mg-0001` | multiturn_gate | 8 | 9 |
