...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 55/102 (53.9%) | CI95 [44.3%, 63.3%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 37/37 (100.0%) (exploratory: N<40) | [90.6%, 100.0%] |
...
outcome 분포: {'correctReject': 127, 'falseAlarm': 1, 'hit': 101, 'miss': 11}
...
- `expansionGateWouldFireRate`: 55/102 (53.9%)
