...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 53/100 (53.0%) | CI95 [43.3%, 62.5%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| `judgmentAccuracy` 판정 정확도 | 204/216 (94.4%) | CI95 [90.5%, 96.8%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 제외)(F-1) |
| `judgmentAccuracyWithGateSlice` 판정 정확도 | 228/240 (95.0%) | CI95 [91.5%, 97.1%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 포함)(F-1) |
...
| constraint_budget_set | 15/28 (53.6%) (exploratory: N<40) | [35.8%, 70.5%] |
| what_axis | 0/0 (해당 없음) | N/A |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
outcome 분포: {'correctReject': 128, 'hit': 100, 'miss': 12}
...
- `expansionGateWouldFireRate`: 53/100 (53.0%)
