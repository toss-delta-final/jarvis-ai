...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 42/98 (42.9%) | CI95 [33.5%, 52.7%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 29/40 (72.5%) | [57.2%, 83.9%] |
| constraint_price | 9/40 (22.5%) | [12.3%, 37.5%] |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 26/37 (70.3%) (exploratory: N<40) | [54.2%, 82.5%] |
| constraint_price | 0/31 (0.0%) (exploratory: N<40) | [0.0%, 11.0%] |
| constraint_budget_set | 16/30 (53.3%) (exploratory: N<40) | [36.1%, 69.8%] |
| what_axis | 0/0 (해당 없음) | N/A |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
outcome 분포: {'correctReject': 128, 'hit': 98, 'miss': 14}
...
- `expansionGateWouldFireRate`: 42/98 (42.9%)
