...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 45/94 (47.9%) | CI95 [38.1%, 57.9%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| constraint_price | 31/40 (77.5%) | [62.5%, 87.7%] |
...
| constraint_price | 0/31 (0.0%) (exploratory: N<40) | [0.0%, 11.0%] |
...
- `expansionGateWouldFireRate`: 45/94 (47.9%)
