...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 47/105 (44.8%) | CI95 [35.6%, 54.3%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| `judgmentAccuracy` 판정 정확도 | 209/216 (96.8%) | CI95 [93.5%, 98.4%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 제외)(F-1) |
| `judgmentAccuracyWithGateSlice` 판정 정확도 | 233/240 (97.1%) | CI95 [94.1%, 98.6%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 포함)(F-1) |
...
| constraint_price | 2/40 (5.0%) | [1.4%, 16.5%] |
| constraint_budget_set | 14/32 (43.8%) (exploratory: N<40) | [28.2%, 60.7%] |
| what_axis | 0/0 (해당 없음) | N/A |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
| constraint_budget_set | 12/30 (40.0%) (exploratory: N<40) | [24.6%, 57.7%] |
| what_axis | 0/0 (해당 없음) | N/A |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
outcome 분포: {'correctReject': 128, 'hit': 105, 'miss': 7}
...
- `expansionGateWouldFireRate`: 47/105 (44.8%)
