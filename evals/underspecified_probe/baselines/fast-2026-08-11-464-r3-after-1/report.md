...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 48/109 (44.0%) | CI95 [35.1%, 53.4%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| `judgmentAccuracy` 판정 정확도 | 211/216 (97.7%) | CI95 [94.7%, 99.0%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 제외)(F-1) |
| `judgmentAccuracyWithGateSlice` 판정 정확도 | 235/240 (97.9%) | CI95 [95.2%, 99.1%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 포함)(F-1) |
...
| constraint_budget_set | 12/31 (38.7%) (exploratory: N<40) | [23.7%, 56.2%] |
| what_axis | 0/0 (해당 없음) | N/A |
...
outcome 분포: {'correctReject': 127, 'falseAlarm': 1, 'hit': 108, 'miss': 4}
...
- `expansionGateWouldFireRate`: 48/109 (44.0%)
...
| `under-cbs-0003` | constraint_budget_set | 8 | 9 |
...
| `under-wa-0003` | what_axis | 8 | 9 |
| `under-wa-0004` | what_axis | 8 | 10 |
