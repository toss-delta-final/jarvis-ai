...
prompt=11c6fe3bfa0c (repo:_SYSTEM) · tier=fast · model=gpt-5-nano · fixture=underspec-anchors-v1 · N=8 · underspecifiedReaskEnabled=True
...
| `filters.attrConditions;semanticQueryIsFallback` | 11 |
| `semanticQueryIsFallback` | 92 |
