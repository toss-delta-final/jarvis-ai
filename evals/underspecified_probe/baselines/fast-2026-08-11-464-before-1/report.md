...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 3/39 (7.7%) (exploratory: N<40) | [2.7%, 20.3%] |
| constraint_price | 8/40 (20.0%) | [10.5%, 34.8%] |
| constraint_budget_set | 3/31 (9.7%) (exploratory: N<40) | [3.3%, 24.9%] |
...
|---|---|---|---|---|---|
| `expansionGateWouldFireRate` 전개 게이트 발동률(판정 True 표본 중) | 46/98 (46.9%) | CI95 [37.4%, 56.7%] | exploratory | detect_expansion_need(...) 가 사유를 돌려준 표본 | 판정 True 인 recommend 표본(F-1) |
...
| `judgmentAccuracy` 판정 정확도 | 198/214 (92.5%) | CI95 [88.2%, 95.3%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 제외)(F-1) |
| `judgmentAccuracyWithGateSlice` 판정 정확도 | 222/238 (93.3%) | CI95 [89.4%, 95.8%] | exploratory | 판정 == expectedReask | recommend 표본(게이트 포함)(F-1) |
| `missRate` 미탐율 | 14/110 (12.7%) | CI95 [7.7%, 20.2%] | confirmatory-primary | 판정 False | expectedReask=true 앵커의 recommend 표본 — 프로덕션은 intent==recommend 인 턴에서만 is_underspecified_turn 을 호출한다(F-1) |
| `missRateUnderExpansionAssumption` 미탐율(전개 가정 상한) | 59/110 (53.6%) | CI95 [44.4%, 62.7%] | exploratory | (판정 False) 또는 (판정 True ∧ detect_expansion_need 가 사유를 돌려줌) | expectedReask=true 앵커의 recommend 표본(F-1) |
...
| constraint_price | 32/40 (80.0%) | [65.2%, 89.5%] |
| constraint_budget_set | 28/31 (90.3%) (exploratory: N<40) | [75.1%, 96.7%] |
...
| constraint_price | 8/40 (20.0%) | [10.5%, 34.8%] |
| constraint_budget_set | 14/31 (45.2%) (exploratory: N<40) | [29.2%, 62.2%] |
| what_axis | 0/0 (해당 없음) | N/A |
| blocking_rating | 0/0 (해당 없음) | N/A |
| multiturn_gate | 0/0 (해당 없음) | N/A |
...
| 슬라이스 | 점수 | CI95 |
|---|---|---|
| no_condition | 34/36 (94.4%) (exploratory: N<40) | [81.9%, 98.5%] |
| constraint_price | 0/32 (0.0%) (exploratory: N<40) | [0.0%, 10.7%] |
| constraint_budget_set | 11/28 (39.3%) (exploratory: N<40) | [23.6%, 57.6%] |
...
|---|---|---|
| **전체(게이트 제외)** | 92.5% | 48.6% |
| no_condition | 92.3% (exploratory: N<40) | 0.0% |
| constraint_price | 80.0% | 0.0% |
| constraint_budget_set | 90.3% (exploratory: N<40) | 0.0% |
...
outcome 분포: {'correctReject': 126, 'falseAlarm': 2, 'hit': 98, 'miss': 14}
...
- `nonRecommendIntentCount`(앵커별·intent별, F-1): {'under-cbs-0003': {'cart_add': 1}, 'under-nc-0002': {'general': 1}} — intent != 'recommend' 표본 수(앵커별·intent별) — 프로덕션은 이 표본에서 is_underspecified_turn 에 도달하지 않는다(F-1). confirmatory 축 분모에서 제외된 표본의 노출 크기이며, 그 실패는 intent 라우팅 축(evals/intent_probe)의 소관이다.
- `expansionGateWouldFireRate`: 46/98 (46.9%)
- `missRateUnderExpansionAssumption`: 59/110 (53.6%)
