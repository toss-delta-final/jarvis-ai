...
- dataset: `2.2.0` / `ef3a5af8b303041d9f44c156d687e3572feed33d2e85469dce1e0aa49a7ecf37`
- algorithm/config: `buyer-metrics-v1` / `buyer-eval-config-v1`
- model config: `{"decompose":"expectedFilters","provider":"scripted","recentPurchaseWindowDays":90,"referenceDate":"2026-08-02","rerank":"deterministicScoringBaseline","weights":{"diversity_bonus":0.1,"popularity":0.15,"profile_match":0.15,"recency":0.05,"recent_purchase_penalty":0.2,"semantic":0.55}}`
...
| cases | 103 |
| ranking cases | 62 |
| nDCG@10 (primary) | 0.440818 |
| filter accuracy | 1.000000 |
| hard constraint violation rate | 0.019417 |
| coverage | 0.332896 |
| diversity | 0.861920 |
| MRR | 0.681336 |
...
| buy-over-0003 | 9406282766 | forbiddenProductId |
| buy-over-0003 | 9406282766 | mustExclude |
...
|---|---:|---:|---:|
| nDCG@10 | 0.440818 | 0.382404 | 0.058414 |
| MRR | 0.681336 | 0.522017 | 0.159319 |
| hard constraint violation rate | 0.019417 | 0.019417 | 0.000000 |
...
| member | 31 | 35 | 0.028571 | confirmatory |
| multi_constraint | 10 | 12 | 0.000000 | exploratory |
| personalization | 11 | 11 | 0.090909 | exploratory |
| personalization_overreach | 6 | 6 | 0.166667 | exploratory |
| repurchase | 7 | 8 | 0.000000 | exploratory |
| search | 62 | 62 | 0.032258 | exploratory |
| single_need | 33 | 71 | 0.028169 | exploratory |
...
| color | 15 | 0 | 0 | 1.000000 | 1.000000 | 1.000000 | 1.000000 | 1.000000 |
| keyword | 103 | 0 | 0 | 1.000000 | 1.000000 | 1.000000 | 1.000000 | 1.000000 |
