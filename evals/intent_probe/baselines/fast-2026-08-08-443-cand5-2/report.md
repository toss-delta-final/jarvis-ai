...
#240 축 순서 요약: `240/144/96/28/13/48/30/16`
...
| `categoryClear` 카테고리-무관 리셋 | 26/32 (81.2%) | resolvedCategoryAction 이 clear 인 표본 수 | 리셋 4발화 × categoryPrior 컨텍스트 × N (N=8 이면 32) |
| | | ⚠ 직접 비교 금지: baselines/fast-2026-08-04 (이 축이 존재하지 않던 런) | |
...
| `switchLegacy2` 전환(#240 2발화) | 13/16 (81.2%) | intent 가 cart_add 이고 cart.productId 가 **되물음 상품이 아닌** LAST_RECOMMENDATIONS 안의 상품인 표본 수 — #240 정의 | #240 이 쓴 전환 2발화(`이어폰으로 할래`·`다른 거 담아줘`) × PENDING_CART × N |
...
| `switch-005\|pendingCart` | 8 | 8 | cart_add 5, recommend 3 |
