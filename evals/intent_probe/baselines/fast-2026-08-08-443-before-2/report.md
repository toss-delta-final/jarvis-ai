...
#240 축 순서 요약: `237/144/93/28/9/48/31/14`
...
- 화면 지시어: 두 목록 밖 productId 확정(위험한 실패, 0 이어야 함): 3
- 상품군 명시 첫 턴: leg 0개(공백) 표본 수: 15
...
| `category-mixed-002\|categoryPrior` | 8 | 8 | general 1, recommend 7 |
...
| `switch-005\|pendingCart` | 8 | 8 | cart_add 6, recommend 2 |
