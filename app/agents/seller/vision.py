"""상품 이미지 vision 분석 (#506, api-spec §3.2 v0.30.0).
...
class ProductImageAnalysis(BaseModel):
    ...
    name: str = Field(description="상품명 제안 — 사진에서 식별한 소재·특징 반영, 40자 이내")
    summary: str = Field(description="한 줄 요약 — 예: '면 100% 오버핏 셔츠'")
    description: str = Field(description="상세 설명 2~4문장 — 사진에서 확인 가능한 사실만")
