...
class Settings(BaseSettings):
    ...
    # 기본 off — Spring 미구현. 켜려면 I-24~I-28 협의·배포가 선행되어야 한다.
    cart_remove_enabled: bool = False
    # 기본 off — Spring 미구현(I-26~I-28). 켜려면 I-24~I-28 협의·배포가 선행되어야 한다.
    ...
    cart_remove_markers: list[str] = ["빼줘", "빼주세요", "빼 줘", "지워줘", "삭제해줘"]
    ...
    # 찜 해제 표지.
    wishlist_remove_markers: list[str] = ["찜 빼줘", "찜 해제해줘", "찜에서 빼줘"]
